...
public class DekripsBg {

    public static byte[] dapatkanBitmapBg(String namaFile, Context context) {
        ...
        try {
            InputStream inputStream = context.getAssets().open(Tetap.NAMA_FOLDER_BG + "/" + namaFile);
